...
var WildMagicSimpleSurgeTable = WildMagicSimpleSurgeTable || (function() {
    'use strict';

    var version = 0.5,
        rangeMax = 100,
        apiCommand = "!wildmagicsimple",
        helpMsg = "Usage - !wildmagicsimple [--help|-h] [--private|-w], rolls on the wildmagic table, optionally whispers result to roller if --private is used. '--help' will return this message.",
        tableName = "Wild Magic Simple Table",
...
on('ready', function() {
    'use strict';
    WildMagicSimpleSurgeTable.CheckInstall();
    WildMagicSimpleSurgeTable.RegisterEventHandlers();
});